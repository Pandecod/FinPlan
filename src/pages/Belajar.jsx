    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white px-6 py-12 mt-20">
      ...
      <section id="hero" className=" bg-gradient-to-r from-blue-50 to-indigo-50">
        <div className="max-w-5xl mx-auto px-4 flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1">
            <h1 className="text-3xl text-right md:text-4xl font-bold text-gray-800">Belajar Finansial Itu Mudah</h1>
            <p className="mt-3 text-right  text-gray-600">Temukan artikel edukasi keuangan mulai dari dasar, cara menabung, investasi hingga mengelola utang. Semua dikemas sederhana agar mudah dipahami</p>
          </div>
        </div>
      </section>
      ...
      <section className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        {articles.map((article) => (
          <div key={article.id} className="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition">
